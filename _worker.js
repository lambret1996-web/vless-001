...
///////////////////////////////////////////////////////全局常量和工具函数///////////////////////////////////////////////
const WS早期数据最大字节 = 10 * 1024, WS早期数据最大头长度 = Math.ceil(WS早期数据最大字节 * 4 / 3) + 4;
const 上行合包目标字节 = 1 * 1024, 上行队列最大字节 = 16 * 1024 * 1024, 上行队列最大条目 = 16384;
const 下行Grain包字节 = 3 * 1024, 下行Grain尾部阈值 = 128, 下行Grain低水位字节 = Math.max(512, 下行Grain尾部阈值 * 12), 下行Grain最大等待轮次 = 1;
let TCP并发拨号数 = 8, 反代并发拨号数 = 5, 预加载竞速拨号 = true;
///////////////////////////////////////////////////////查杀特征码///////////////////////////////////////////////
const 特征码字典 = [
