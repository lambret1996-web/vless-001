...
const 上行合包目标字节 = 1 * 1024, 上行队列最大字节 =32 * 1024 * 1024, 上行队列最大条目 = 16384;
const 下行Grain包字节 = 2 * 1024, 下行Grain尾部阈值 = 128, 下行Grain低水位字节 = Math.max(256, 下行Grain尾部阈值 * 12), 下行Grain最大等待轮次 = 1;
